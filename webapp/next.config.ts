...
const nextConfig: NextConfig = {
  images: {
    // Only trusted first-party hosts. Supabase Storage serves every real
    // avatar / company logo / résumé attachment (public buckets: avatars,
    // company-media, intro-videos). No third-party placeholder host allowed:
    // seed_prod.sql (which used picsum.photos) has been removed, and the
    // launch invariant is "real data only".
