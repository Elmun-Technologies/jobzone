...
class _OfflineNotifications {
  ...
  final items = <AppNotification>[
    AppNotification(
      ...
      body: 'Your application for Senior Flutter Engineer is now Shortlisted.',
    ...
    AppNotification(
      ...
      title: 'New message',
      body: 'Dilnoza: Looking forward to our chat!',
    ...
    AppNotification(
      ...
      title: 'New job match',
      body: 'Backend Developer (Node.js) at Acme matches your preferences.',
      isRead: true,
